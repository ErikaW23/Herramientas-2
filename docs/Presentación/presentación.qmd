...
Objetivo: aplicar un modelo preentrenado de clasificación de imágenes y analizar su desempeño, conectándolo con la fundamentación matemática de las bitácoras. Tarea: clasificación de imágenes. Relevancia actuarial (1 línea): el nivel de confianza de una predicción puede usarse para distinguir casos procesables automáticamente vs. casos que requieren revisión humana (ej. fotos de reclamos o daños en seguros).

## Tarea seleccionada y justificación

Tarea: clasificación de imágenes. Modelo: ViT-Base (Vision Transformer, variante patch16-224), vía el paquete Transformers. Por qué: adapta el mecanismo de atención de los Transformers (NLP) al análisis visual — permite ilustrar cómo la IA puede apoyar procesos de segmentación y predicción de riesgos en el trabajo actuarial.

## Descripción del dataset

Fuente: Caltech 101 (Fei-Fei, Andreetto, Ranzato & Perona, Caltech, 2003), con la referencia completa en el footnote. Tamaño: \~9,000 imágenes en 101 categorías; entre 40 y 800 imágenes por clase (la mayoría \~50), con desbalance notorio entre clases. Detalle: imágenes \~300×200 px, objetos centrados, fondos simples, con anotaciones manuales de contorno.
